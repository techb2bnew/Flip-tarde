...
const Pipuse = () => {
  return (
    <div className="bg-white">
      ...
      >
        <div className="max-w-[1340px] m-auto py-18">
          <div className="text-center">
            <Title title="Why Use It?" color="text-secondary" />
          </div>
          <div className="pt-12 grid grid-cols-2 gap-y-18 gap-x-6">
              ...
              >
                <div
                  className={`${index == 1 || index == 2
                    ? "bg-subprimary"
                    : "bg-primary"} py-7 px-12 max-w-[400px] w-full text-[40px] font_ternary  rounded-[70px] text-white ${index %
                    2 ===
                  0
                    ? "text-end"
                    : "text-start"}`}
                ...
                <div
                  className={`absolute z-[20] top-[-20px] bg-[#E2E2FF] py-6 px-16 max-w-[500px] w-full text-[40px] font_ternary text-end rounded-[90px] text-white transition-all duration-700 cursor-pointer ${index %
                    2 ===
                  0
                    ? "right-[19%] hover:right-0"
                    : " left-[19%] hover:left-0"}`}
                >
                  <div
